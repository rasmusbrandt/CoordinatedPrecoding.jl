...
function check_aux_precoding_params!(aux_params::AuxPrecodingParams, ::Type{Shi2011_WMMSEState})
    if !haskey(aux_params, "Shi2011_WMMSE:bisection_Gamma_cond")
        aux_params["Shi2011_WMMSE:bisection_Gamma_cond"] = 1e10
    end
    if !haskey(aux_params, "Shi2011_WMMSE:bisection_singular_Gamma_mu_lower_bound")
        aux_params["Shi2011_WMMSE:bisection_singular_Gamma_mu_lower_bound"] = 1e-14
    end
    if !haskey(aux_params, "Shi2011_WMMSE:bisection_max_iters")
        aux_params["Shi2011_WMMSE:bisection_max_iters"] = 5e1
    end
    if !haskey(aux_params, "Shi2011_WMMSE:bisection_tolerance")
        aux_params["Shi2011_WMMSE:bisection_tolerance"] = 1e-3
    end
end
